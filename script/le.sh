...
certbot certonly -t -n --agree-tos --renew-by-default --dns-cloudflare-credentials /secrets/cloudflare.ini --email "${LE_EMAIL}" --webroot -w /usr/share/nginx/html -d ${LE_FQDN}
le_result=$?
